...
rpm-ostree install ffmpeg distrobox gstreamer1-plugin-libav gstreamer1-plugins-bad-free-extras gstreamer1-plugins-bad-freeworld gstreamer1-plugins-ugly gstreamer1-vaapi intel-media-driver libva-intel-driver libva-nvidia-driver openresolv
